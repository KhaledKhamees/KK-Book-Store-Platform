...
namespace MVCProject2.Migrations
{
    ...
    [Migration("20241005053303_AddOrderHeaderAndOrderDetailsToDataBase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCProject2.Models.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCProject2.Models.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCProject2.Models.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCProject2.Models.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCProject2.Models.Models.ApplecationUser", b =>
                {
            ...
            modelBuilder.Entity("MVCProject2.Models.Models.OrderDetail", b =>
                {
                    b.HasOne("MVCProject2.Models.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVCProject2.Models.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MVCProject2.Models.Models.OrderHeader", b =>
                {
                    b.HasOne("MVCProject2.Models.Models.ApplecationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MVCProject2.Models.Models.ShoppingCart", b =>
                {
                    b.HasOne("MVCProject2.Models.Models.ApplecationUser", "ApplecationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MVCProject2.Models.Models.ApplecationUser", b =>
                {
                    b.HasOne("MVCProject2.Models.Models.Company", "company")
                        .WithMany()
